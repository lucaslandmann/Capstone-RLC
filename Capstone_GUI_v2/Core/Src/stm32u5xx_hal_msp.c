...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = Channel_5_Volume_Pin|Master_Volume_Pin|Channel_1_LR_Pin|Channel_2_LR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    */
    ...
    __HAL_LINKDMA(hadc, DMA_Handle, handle_GPDMA1_Channel8);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, Channel_5_Volume_Pin|Master_Volume_Pin|Channel_1_LR_Pin|Channel_2_LR_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PG1     ------> ADC4_IN8
    */
    HAL_GPIO_DeInit(GPIOG, Channel_5_LR_Pin|Channel_6_LR_Pin);
...
/* SAI2 */
    ...
    */
    ...
    handle_GPDMA1_Channel7.InitLinkedList.Priority = DMA_LOW_PRIORITY_MID_WEIGHT;
    ...
    __HAL_LINKDMA(hsai, hdmarx, handle_GPDMA1_Channel7);
