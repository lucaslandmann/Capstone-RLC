...
/* Private defines -----------------------------------------------------------*/
#define ADC_Power_On_Pin GPIO_PIN_2
#define ADC_Power_On_GPIO_Port GPIOE
...
#define Master_Mute_Pin GPIO_PIN_7
#define Master_Mute_GPIO_Port GPIOD
#define Channel_6_Mute_Pin GPIO_PIN_9
#define Channel_6_Mute_GPIO_Port GPIOG
#define Channel_2_Mute_Pin GPIO_PIN_12
#define Channel_2_Mute_GPIO_Port GPIOG
#define Master_MuteG15_Pin GPIO_PIN_15
#define Master_MuteG15_GPIO_Port GPIOG
#define Channel_5_Mute_Pin GPIO_PIN_5
#define Channel_5_Mute_GPIO_Port GPIOB
#define Channel_4_Mute_Pin GPIO_PIN_6
#define Channel_4_Mute_GPIO_Port GPIOB
#define Channel_3_Mute_Pin GPIO_PIN_7
#define Channel_3_Mute_GPIO_Port GPIOB
#define Channel_1_Mute_Pin GPIO_PIN_8
#define Channel_1_Mute_GPIO_Port GPIOB
